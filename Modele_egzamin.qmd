...
3. Scale-Location - wykres reszt standaryzowanych względem wartościdopasowanych <br/>
4. Cook’s distance - wykres odległości Cooka <br/>
5. Residuals vs Leverage - wykres reszt względem dźwign <br/>
...
- Reszty studentyzowane $$t_i=\frac{e}{s_{(i)}\sqrt{1-h_{ii}}}$$ gdzie <br/>
